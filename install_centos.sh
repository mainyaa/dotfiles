...
# direnv
curl -L https://github.com/zimbatm/direnv/releases/download/v2.5.0/direnv.linux-amd64 > direnv
sudo chmod +x direnv
...
# peco
curl -L https://github.com/peco/peco/releases/download/v0.3.2/peco_linux_amd64.tar.gz > peco
sudo chmod +x peco
...
#curl -L https://raw.github.com/hnakamur/setup_linux/master/centos6/install_chef-solo.sh | sh
...
curl -L https://github.com/peco/peco/releases/download/v0.3.2/peco_linux_386.tar.gz > sudo /usr/local/bin
